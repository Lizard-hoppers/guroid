...
// название, подзаголовок, "Telegram Mini App". 2 сек (фидбек владельца
// 28.08.2026: сначала 550мс — "очень быстро уходит", подняли до 3 сек;
// затем "давай 2 секунды, три как будто много" — 3 сек ощущались уже
// затянутыми).
const SHOW_MS = 2000;
