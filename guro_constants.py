...
# Бонус за стаж в комьюнити — 15.08.2026 убирался совсем ("рейтинг растёт
# только от сделок"), 16.08.2026 возвращён обратно по официальному макету
# владельца ("рейтинг порядок.pdf" — "рейтинг состоит из 3 составляющих:
# дни в комьюнити + успешные сделки", этот документ имеет приоритет над
# устным решением днём раньше). Значения — те же, что были исходно.
