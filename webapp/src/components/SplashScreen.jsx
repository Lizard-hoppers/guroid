...
// название, подзаголовок, "Telegram Mini App". 3 сек (фидбек владельца
// 28.08.2026: "очень быстро уходит, сделай 3 секунды чтобы все можно
// было розглядеть" — первая версия была 550мс, показалась слишком
// короткой, чтобы успеть рассмотреть).
const SHOW_MS = 3000;
